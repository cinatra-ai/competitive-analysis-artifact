...
// and the install pipeline cannot disagree. Per the ratified explicit-type
// rule (epic cinatra#1785), a `kind:"artifact"` extension DECLARES the object
// types it owns: each entry names a namespaced object type
// id, a claim kind ('dedicated' | 'default'), an optional strict dispositions
// payload, and an optional inline JSON Schema for the declared rows.
...
// Mutability class (cinatra#1449, merged #1770): how a declared type's rows may
...
/** The package that REGISTERS a declared type: the namespace of its id
 ...
 * fail-closed): every declared type must ship an inline JSON Schema, OR be
